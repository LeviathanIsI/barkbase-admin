...
export function ImpersonateModal({ tenant, isOpen, onClose }: ImpersonateModalProps) {
  ...
  return (
    <SlideOutPanel
      isOpen={isOpen}
      onClose={onClose}
      title={canImpersonate ? 'Impersonate Tenant' : 'Permission Denied'}
      subtitle={canImpersonate ? tenant.name : undefined}
      width="sm"
      footer={footer}
    >
      {!canImpersonate ? (
        <div className="flex items-center gap-3">
          <div className="w-10 h-10 rounded-full bg-[var(--color-error-soft)] flex items-center justify-center flex-shrink-0">
        ...
        <>
          {/* Warning */}
          <div className="p-4 bg-[var(--color-warning-soft)] rounded-lg mb-4">
